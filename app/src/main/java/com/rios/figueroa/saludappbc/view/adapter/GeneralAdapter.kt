...
class GeneralAdapter(val context: android.content.Context): RecyclerView.Adapter<GeneralAdapter.ViewHolder>(){
    private var medicosLista= mutableListOf<medicoGeneral>()

    fun setListData(data:MutableList<medicoGeneral>){
        medicosLista = data
    }
